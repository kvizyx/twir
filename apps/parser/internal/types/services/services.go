...
import (
	...
	"github.com/satont/twir/apps/parser/internal/parser"
...
type Services struct {
	...
	Bus                     *buscore.Bus
	CommandsCache           *genericcacher.GenericCacher[[]model.ChannelsCommands]
	SevenTvCache            *genericcacher.GenericCacher[*seventv.ProfileResponse]
	SevenTvCacheBySevenTvID *genericcacher.GenericCacher[*seventv.ProfileResponse]
	RedSync                 *redsync.Redsync
	CommandsLock            *redsync.Mutex
	CommandsParser          parser.Parser
}
